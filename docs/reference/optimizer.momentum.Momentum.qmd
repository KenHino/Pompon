# optimizer.momentum.Momentum { #pompon.optimizer.momentum.Momentum }
...
| Name | Description |
| --- | --- |
| [get_trace](#pompon.optimizer.momentum.Momentum.get_trace) | Get the optimization trace |
| [optimize](#pompon.optimizer.momentum.Momentum.optimize) | Optimize the parameters of the model |
| [setup](#pompon.optimizer.momentum.Momentum.setup) |  |
| [update](#pompon.optimizer.momentum.Momentum.update) | update whole parameters one step |

### get_trace { #pompon.optimizer.momentum.Momentum.get_trace }
...
### optimize { #pompon.optimizer.momentum.Momentum.optimize }

`optimizer.momentum.Momentum.optimize(epochs=1000, epoch_per_trace=1, epoch_per_log=500, epoch_per_save=100000000, fix_coord=False, fix_basis=False, wf=1.0)`
...
`optimizer.momentum.Momentum.setup(model, x_train, y_train, *, batch_size=100, shuffle=True, x_test=None, y_test=None, f_train=None, f_test=None, jobname=None, outdir='.')`
...
### update { #pompon.optimizer.momentum.Momentum.update }
